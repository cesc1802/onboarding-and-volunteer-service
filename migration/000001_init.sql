...
CREATE TABLE IF NOT EXISTS volunteer_details (
    ...
    CONSTRAINT fk_volunteer_details_countries FOREIGN KEY (country_id) REFERENCES countries (id),
    CONSTRAINT fk_volunteer_details_resident_countries FOREIGN KEY (resident_country_id) REFERENCES countries (id),
